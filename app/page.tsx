	...
	return (
		<main className="text-white">
			...
			<section className="w-full bg-slate-700 lg:p-32 p-6">
				<div className="lg:max-w-screen-md">
					<h1 className="text-6xl mb-12">Bridger Tower <span className='block text-2xl opacity-75 leading-tight mt-4'>Product Designer / Frontend Developer</span></h1>
        ...
        <div className="lg:max-w-screen-md">
          <h3 className="text-4xl">
						...
						<span className='highlight'>aesthetics</span> and <span className='highlight'>usability</span> on the web and in software.
					</h3>
				</div>
			</section>
		</main>
